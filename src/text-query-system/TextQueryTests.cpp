...
const auto MIN_ILLEGAL_SIZE_FOR_QUERY = 2;
// ------------- Tests for Word ----------------
...
//// Write this test...
//   auto test_string2 = ""s;
//   test_string2.resize(MIN_ILLEGAL_SIZE_FOR_QUERY, 'a'); //resizes string to less than 3 letters(2 letters)
//   auto test_word2 = Word{test_string2};
//   CHECK(test_word2.isQueryable() == 0); //checks if the function returns false if string is less than 3
//}
